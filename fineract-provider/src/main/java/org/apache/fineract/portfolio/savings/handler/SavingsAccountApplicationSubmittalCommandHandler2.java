...
@Service
@CommandType(entity = "SAVINGSACCOUNT", action = "CREATE2")
public class SavingsAccountApplicationSubmittalCommandHandler2 implements NewCommandSourceHandler {

    private final SavingsApplicationProcessWritePlatformService savingAccountWritePlatformService;

    @Autowired
    public SavingsAccountApplicationSubmittalCommandHandler2(
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.savingAccountWritePlatformService.submitApplication2(command);
    }
}